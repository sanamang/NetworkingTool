...
import { LayoutDashboard, Users, Send, Calendar, Activity, Settings, Search, LogOut } from "lucide-react";
import { supabase } from "@/lib/supabase";
import { logout, displayName, userInitials } from "@/lib/auth";
      ...
      <aside className="hidden md:flex w-60 shrink-0 flex-col border-r border-sidebar-border bg-sidebar">
        ...
        <div className="p-3 border-t border-sidebar-border">
          <div className="flex items-center gap-2.5 px-2 py-1.5">
            ...
            <button onClick={handleLogout} title="Sign out" className="p-1.5 rounded-md text-muted-foreground hover:text-foreground hover:bg-sidebar-accent/60 transition-colors shrink-0">
